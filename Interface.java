...
public class Interface {
	...
	public static JComboBox interfaceHours;
	public static JComboBox interfaceMinutes;
	public static JComboBox interfaceSeconds;
	...
	private void initialize() {
		...
		final JButton stopBtn = new JButton("Stope");
		...
		startBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				    ...
				    timeField.setText((String.format("%02d", Integer.parseInt((String) interfaceHours.getSelectedItem()))) + ":" + 
				                      (String.format("%02d", Integer.parseInt((String) interfaceMinutes.getSelectedItem().toString()))) + ":" + 
				    		          (String.format("%02d", Integer.parseInt((String) interfaceSeconds.getSelectedItem().toString()))));
	...
	public void updatus() {
		   ...
		   if((updHours + updMinutes + updSeconds) != 0) updTimer1.scheduleAtFixedRate(new TimerTask() {
			   @Override
			   public void run() {			   
				   				   
				   if(updHours != 0 && updMinutes != 0 && updSeconds != 0){updSeconds--;                                      timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours != 0 && updMinutes != 0 && updSeconds == 0){updSeconds = 59; updMinutes--;                timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours != 0 && updMinutes == 0 && updSeconds == 0){updSeconds = 59; updMinutes = 59; updHours--; timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours != 0 && updMinutes == 0 && updSeconds != 0){updSeconds--;                                 timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours == 0 && updMinutes != 0 && updSeconds != 0){updSeconds--;                                 timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours == 0 && updMinutes != 0 && updSeconds == 0){updMinutes--; updSeconds = 59;                timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours == 0 && updMinutes == 0 && updSeconds != 0){updSeconds--;                                 timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   else if(updHours == 0 && updMinutes == 0 && updSeconds == 0){this.cancel(); startBtn.setEnabled(true);   timeField.setText((String.format("%02d", updHours)) + ":" + (String.format("%02d", updMinutes)) + ":" + (String.format("%02d", updSeconds)));}
				   

			   }
		   }, 1000, 1000); 
		   else startBtn.setEnabled(true);
	}
	
	
	public void getVariables() {
		   updHours = Integer.parseInt(interfaceHours.getSelectedItem().toString());
		   updMinutes = Integer.parseInt(interfaceMinutes.getSelectedItem().toString());
		   updSeconds = Integer.parseInt(interfaceSeconds.getSelectedItem().toString());
	}
